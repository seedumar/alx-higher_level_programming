...
OAOAOA        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "height must be > 0"):
OAOAOA            r.update(89, 1, 0)
...
OBOBOB        self.assertEqual("[Rectangle] (99) 8/5 - 1/2", str(r))

    def test_update_kwargs_None_id(self):
        r = Rectangle(10, 10, 10, 10, 10)
OBOBOB        r.update(id=None)
OBOBOB        correct = "[Rectangle] ({}) 10/10 - 10/10".format(r.id)
        self.assertEqual(correct, str(r))
...
OBOBOB        self.assertEqual(correct, str(r))
